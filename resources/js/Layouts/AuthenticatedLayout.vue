<script setup>
import MainMenu from '@/Components/Admin/Menus/MainMenu.vue';
    ...
    <div :class="$page.props.app.settingsStyles.main.body">
            ...
            <div class="container mx-auto mt-1 text-justify px-0 md:px-3 rounded-lg"
                ...
                <!-- <div
                    ...
                    <svg class="h-6 w-auto inline" viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear" x1="3.5" y1="16" x2="59" y2="48"
        ...
        <footer class="p-4 rounded-lg shadow md:px-6 md:py-8" :class="$page.props.app.settingsStyles.main.footer">
            ...
            <span class="block text-sm sm:text-center">
                © 2022-{{ moment().format('YYYY') }} Rodando com <a href="https://crebs.dev"
