...
<template>
    ...
    <InnerSection v-if="Object.entries(clientData).length > 0">
        <template #header>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full mb-2 px-1">
                    <thead>
                        <tr>
                            <th
                                class="px-3 py-1.5 md:px-6 md:py-3 bg-red-100 border-b-2 border-gray-300 text-left leading-4 tracking-wider dark:bg-red-300 text-gray-800">
                                Coluna
                            </th>
