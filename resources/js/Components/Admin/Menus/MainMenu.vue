...
<template>
    <div id="main_menu" class="shadow-lg pb-1 rounded-b-3xl min-w-full md:min-w-[50%] mx-auto"
        ...
        <div class="px-2 py-1 items-center justify-around " :class="showMenuItems">
            <div class="flex flex-col items-center">
                ...
                <span class="text-[7.6px] sm:text-[14px] xl:text-[18px] font-medium text-center">
                    Painel
                </span>
                </Link>
            </div>
